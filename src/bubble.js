...
var createBubble = function () {
	...
	this.xOff = Math.random() * innerWidth - this.radius;
	this.yOff = Math.random() * innerHeight;
    ...
    const gradientInstance = ctx.createLinearGradient(0, 0, canvas.width, canvas.height);
    gradientInstance.addColorStop(0, 'red');
    gradientInstance.addColorStop(.5, 'blue');
    gradientInstance.addColorStop(1, 'green');
